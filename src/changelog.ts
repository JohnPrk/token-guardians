...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    title: "캐릭터 우클릭 메뉴",
    body: `
- 캐릭터를 우클릭했을 때 동작을 고를 수 있어요. 설정의 **캐릭터 우클릭 시 동작**에서 "즉시 새로고침"과 "동작 메뉴 표시" 중 선택하면 됩니다.
- "동작 메뉴 표시"를 켜면, 메뉴에 보일 항목(새로고침·설정·계정 전환 등)을 하나씩 켜고 끌 수 있어요. 메뉴바 메뉴와 같은 항목이고, 우클릭 메뉴에만 적용됩니다.
`,
  },
  {
    version: "2.25.0",
